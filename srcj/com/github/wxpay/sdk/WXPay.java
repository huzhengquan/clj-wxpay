...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config) throws Exception {
        this(config, true, false, SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final boolean autoReport) throws Exception {
        this(config, autoReport, false, SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final boolean autoReport, final boolean useSandbox) throws Exception {
        this(config, autoReport, false, SignType.MD5);
    }
    public WXPay(final WXPayConfig config, final boolean autoReport, final boolean useSandbox, final SignType signType) throws Exception {
        this.config = config;
